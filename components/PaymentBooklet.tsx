...
import { Sale, Customer, Installment } from '../types';
...
const PaymentSlip: React.FC<{ sale: Sale; customer: Customer; installment: Installment; index: number; total: number }> = ({ sale, customer, installment, index, total }) => {
    return (
        <div className="bg-white text-black p-4 border border-dashed border-gray-400 flex flex-col justify-between text-xs break-inside-avoid-page">
            <div>
                <div className="flex justify-between items-center border-b border-gray-300 pb-2 mb-2">
                    <div>
                        <h2 className="font-bold text-sm">Donna Parfum</h2>
...
const PaymentBooklet: React.FC<PaymentBookletProps> = ({ sale, customer, onClose }) => {
    const handlePrint = () => {
        window.print();
    };
    ...
    return (
        <div className="fixed inset-0 bg-gray-700 bg-opacity-75 z-50 flex flex-col items-center p-4 print:p-0 print:bg-white printable-area">
            ...
            <div className="bg-white p-4 rounded-lg shadow-xl print-controls w-full max-w-4xl mb-4">
                <div className="flex justify-between items-center">
                    <h2 className="text-xl font-bold text-gray-800">Carnê de Pagamento</h2>
